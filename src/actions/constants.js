...
export const userConstants = {
  ...
  USER_REGISTER_SUCCESS: 'USER_REGISTER_REQUEST',
  USER_REGISTER_FAILURE: 'USER_REGISTER_FAILURE',
};

export const categoryContstant = {
...
export const productsConstant = {
  GET_ALL_PRODUCT_REQUREST: 'GET_ALL_PRODUCT_REQUREST',
...
export const initialDataConstant = {
  GET_ALL_INITIAL_DATA_REQUREST: 'GET_ALL_INITIAL_DATA_REQUREST',
